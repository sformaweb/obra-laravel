...
<div class="container">
                    ...
                    <form class="row g-3 mt-4" method="POST" action="{{ route('ofertats.update', $ofertats->id) }}" autocomplete="off">
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="lugar" name="lugar"
                                        placeholder="Lugar..." value="{{ $ofertats->lugar }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="tipo" name="tipo"
                                        placeholder="Tipo" value="{{ $ofertats->tipo }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="numhoras" name="numhoras"
                                        placeholder="Horas" value="{{ $ofertats->numhoras }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-10">
                                    <input type="numprazas" class="form-control" id="numprazas" name="numprazas"
                                        placeholder="Prazas" maxlength="9" value="{{ $ofertats->numprazas }}" required>
                                </div>
                            </div>
