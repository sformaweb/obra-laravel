    ...
    <div class="container-fluid px-md-5 my-4">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item w-auto" role="presentation">
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#datosempresa"
                    type="button" role="tab" aria-controls="home" aria-selected="true">Datos Empresa</button>
            </li>
            <li class="nav-item w-auto" role="presentation">
                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#seguimento"
                    type="button" role="tab" aria-controls="profile" aria-selected="false">Seguimento</button>
            </li>
            <li class="nav-item w-auto" role="presentation">
                <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#ofertasdeformacion"
                    type="button" role="tab" aria-controls="contact" aria-selected="false">Ofertas de Formación</button>
            </li>
            <li class="nav-item w-auto" role="presentation">
                <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#ofertasdecontratacion"
                    type="button" role="tab" aria-controls="contact" aria-selected="false">Ofertas de Contratación</button>
            </li>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade py-3 px-4 show active" id="datosempresa" role="tabpanel"
                aria-labelledby="datosempresa-tab">
                <div class="container">
                    {{-- METODO DISTINTO QUE EL DE CREAR - SOLO CUBRE LOS DATOS DE MOMENTO --}}
                    <form class="row g-3 mt-4" method="POST" action="{{ route('empresas.update', $empresas->id) }}" autocomplete="off">
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="localidade" name="localidade"
                                        placeholder="Localidade..." value="{{ $empresas->localidade }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="poboacion" name="poboacion"
                                        placeholder="Poboacion" value="{{ $empresas->poboacion }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="actividade" name="actividade"
                                        placeholder="Actividade" value="{{ $empresas->actividade }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-10">
                                    <input type="tel" class="form-control" id="telefono" name="telefono"
                                        placeholder="Teléfono" maxlength="9" value="{{ $empresas->telefono }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="tel" class="form-control" id="fax" name="fax" placeholder="Número de Fax"
                                        value="{{ $empresas->fax }}" maxlength="9">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-10">
                                    <input type="date" class="form-control" id="email" name="data_incorporacion"
                                        placeholder="dd-mm-aa" value="{{ $empresas->data_incorporacion }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="persoa_contacto" name="persoa_contacto"
                                        placeholder="" value="{{ $empresas->persoa_contacto }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" id="orientador" name="orientador" value="{{ $empresas->orientador }}">
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="number" class="form-control" id="email" name="ofertas_contratacion"
                                        placeholder="Ofertas emprego" value="{{ $empresas->ofertas_contratacion }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="number" class="form-control" id="email" name="ofertas_formacion"
                                        placeholder="Ofertas formacion" value="{{ $empresas->ofertas_formacion }}" required>
                                </div>
                            </div>
                        ...
                        <div>
                            <strong><label for="relacion-conselleria" class="control-label">RELACIÓNS COA
                                    CONSELLERÍA:</label></strong>
                        </div>
                        <div>
                        ...
                        <div class="col-md-4">
                            <div class="my-4">
                                <a href="{{ url('/empresas/index') }}" class="btn btn-default">VOLVER</a>
                ...
                <div class="container mt-4">
                    ...
                    <div class="my-4">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"
                            data-bs-whatever="@mdo">Novo Seguimento</button>
                    </div>
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="functions/guardar.php" autocomplete="off">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="date" class="form-control" id="data_modal"
                                                    name="data_incorporacion_modal" placeholder="dd-mm-aa" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="orientador" class="control-label">Orientador/a</label>
                                            <div class="col-sm-10">
                                                <select class="form-control" id="orientador_modal"
                                                    name="orientador_modal">
                                                    <option value="">Cea Rodríguez, Alberte</option>
                                                    <option value="">García Barbosa, Eva</option>
                                                    <option value="">De Monasterio Roldan, Celia</option>
                                                </select>
            ...
            <div class="tab-pane fade py-3 px-4 " id="ofertasdeformacion" role="tabpanel"
                aria-labelledby="ofertasdeformacion-tab">
            ...
            <div class="tab-pane fade py-3 px-4 " id="ofertasdecontratacion" role="tabpanel"
                aria-labelledby="ofertasdecontratacion-tab">
                <div class="container mt-4">
