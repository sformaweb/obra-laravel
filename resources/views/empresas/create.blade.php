...
@section('content')
    ...
    <div class="container-fluid px-md-5 my-4">
        <h4 class="mb-4 text-primary text-center"><b>NOVO REXISTRO EMPRESA</b></h4>
        <!-- TABS -->
        <!-- tabs menu -->
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade py-3 px-4 show active" id="datosempresa" role="tabpanel"
                ...
                <div class="container">
                    <form class="row g-3 mt-4" method="POST" action="{{ route('empresas.store') }}" autocomplete="off">
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="poboacion" name="poboacion"
                                        placeholder="Poboacion" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="number" class="form-control" id="email" name="ofertas_contratacion"
                                        placeholder="Ofertas emprego" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="number" class="form-control" id="email" name="ofertas_formacion"
                                        placeholder="Ofertas formacion" required>
                                </div>
                            </div>
