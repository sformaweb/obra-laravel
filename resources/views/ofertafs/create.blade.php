...
@section('content')
    ...
    <div class="container-fluid px-md-5 my-4">
        <h4 class="mb-4 text-primary text-center"><b>NOVA OFERTA DE FORMACIÓN</b></h4>
 

<div class="container">
                    <form class="row g-3 mt-4" method="POST" action="{{ route('ofertafs.store') }}" autocomplete="off">
