            ...
            <div class="container">
              <div class="row align-items-start my-3">
                <div class="col p-2 me-lg-4 bd-highlight text-start">
                  ...
                  <p class="flex-md-wrap"><span class="opacity-50">NOME:</span><span class="text-nowrap"> {{$persoas->nome}}</span></p>
                  <p class="flex-md-wrap"><span class="opacity-50">1º APELIDO:</span> {{$persoas->primeiro_apelido}}</p>
                  <p class="flex-md-wrap"><span class="opacity-50">2º APELIDO:</span> {{$persoas->segundo_apelido}}</p>
                </div>

                <div class="col p-2 me-lg-4 bd-highlight text-start">
                  <p class="text-nowrap"><span class="opacity-50">DNI/NIF:</span> {{$persoas->nif}}</p>
                  <p class="flex-md-wrap"><span class="opacity-50">DATA DE NACEMENTO:</span> <span class="text-nowrap">{{$persoas->data_nacemento}}</span></p>
                  <p class="text-nowrap"><span class="opacity-50">SEXO:</span> {{$persoas->sexo}} </p>
                </div>

                <div class="col p-2 me-lg-4 bd-highlight text-start">
                  <p class="text-nowrap"><span class="opacity-50">TELÉFONO:</span> {{$persoas->telefono}}</p>
                  <p class="flex-md-nowrap"><span class="opacity-50">CORREO ELECTRÓNICO:</span> {{$persoas->email}}</p>
                  <p class="text-nowrap"><span class="opacity-50">CP:</span> {{$persoas->codigo_postal}}</p>
                </div>
              </div>
