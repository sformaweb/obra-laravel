...
@section('content')
    ...
    <div class="container-fluid px-md-5 my-4">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item w-auto" role="presentation">
                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#formacion"
                    type="button" role="tab" aria-controls="profile" aria-selected="false">Formación</button>
            </li>
            <li class="nav-item w-auto" role="presentation">
                <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#experiencia"
                    type="button" role="tab" aria-controls="contact" aria-selected="false">Experiencia</button>
            </li>
            <li class="nav-item w-auto" role="presentation">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade py-3 px-4 show active" id="datospersoais" role="tabpanel"
                ...
                <!-- DATOS PERSOAIS -->
                <div class="container">
                    {{-- METODO DISTINTO QUE EL DE CREAR - SOLO CUBRE LOS DATOS PERSONALES DE MOMENTO --}}
                    <form class="row g-3 mt-4" action="{{ route('persoas.update', $persoas->id) }}" method="POST"
                        autocomplete="off">
                        @csrf
                        {{ method_field('PUT') }}
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="nombre" name="primeiro_apelido"
                                        placeholder="Primeiro Apelido" value="{{ $persoas->primeiro_apelido }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="nombre" name="segundo_apelido"
                                        placeholder="Segundo Apelido" value="{{ $persoas->segundo_apelido }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="tel" class="form-control" id="nif" name="nif" placeholder="Número do DNI"
                                        pattern="[0-9]{8}+[A-Z]{1}" maxlength="9" value="{{ $persoas->nif }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="date" class="form-control" id="data_nacemento" name="data_nacemento"
                                        placeholder="dd-mm-aa" value="{{ $persoas->data_nacemento }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="tel" class="form-control" id="codigo_postal" name="codigo_postal"
                                        placeholder="Código postal" maxlength="5" value="{{ $persoas->codigo_postal }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="tel" class="form-control" id="telefono" name="telefono"
                                        placeholder="Teléfono" maxlength="9" value="{{ $persoas->telefono }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="email" class="form-control" id="email" name="email"
                                        placeholder="Correo electrónico" value="{{ $persoas->email }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
