    ...
    <div class="container-fluid px-md-5 my-4">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade py-3 px-4 show active" id="datospersoais" role="tabpanel"
                ...
                <!-- DATOS PERSOAIS -->
                <div class="container">
                    <form class="row g-3 mt-4" action="{{ route('persoas.store') }}" method="POST" autocomplete="off">
                        {{-- NO BORRAR EL ARROBA --}} @csrf
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="nombre" name="primeiro_apelido"
                                        placeholder="Primeiro Apelido" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="nombre" name="segundo_apelido"
                                        placeholder="Segundo Apelido" required>
                                </div>
                            </div>
